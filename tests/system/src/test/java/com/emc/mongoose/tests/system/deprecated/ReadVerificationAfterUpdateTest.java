 ...
 */
@Ignore public class ReadVerificationAfterUpdateTest
extends EnvConfiguredScenarioTestBase {
	...
	throws Exception {
		...
		STEP_ID = ReadVerificationAfterUpdateTest.class.getSimpleName();
		SCENARIO_PATH = Paths.get(
			getBaseDir(), DIR_SCENARIO, "systest", "ReadVerificationAfterUpdate.json"
		);
