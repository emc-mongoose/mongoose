 ...
 */
public final class JsonReadUsingInputFileLimitByCountTest
extends OldScenarioTestBase {
	...
	public JsonReadUsingInputFileLimitByCountTest(
	...
	protected String makeStepId() {
		return JsonReadUsingInputFileLimitByCountTest.class.getSimpleName() + '-' + storageType.name() +
