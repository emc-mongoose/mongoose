 ...
 */
public class JsonMultiPartCreateTest
extends OldScenarioTestBase {
	...
	private String itemOutputFile = JsonMultiPartCreateTest.class.getSimpleName() + "Items.csv";

	public JsonMultiPartCreateTest(
	...
	protected String makeStepId() {
		return JsonMultiPartCreateTest.class.getSimpleName() + '-' + storageType.name() + '-' +
