 ...
 */
public final class JsonReadVerificationDisableTest
extends OldScenarioTestBase {
	...
	public JsonReadVerificationDisableTest(
	...
	protected String makeStepId() {
		return JsonReadVerificationDisableTest.class.getSimpleName() + '-' + storageType.name() +
