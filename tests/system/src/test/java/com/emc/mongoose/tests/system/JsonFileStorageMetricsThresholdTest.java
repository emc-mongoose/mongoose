 ...
 */
public class JsonFileStorageMetricsThresholdTest
extends OldScenarioTestBase {
	...
	public JsonFileStorageMetricsThresholdTest(
	...
	protected Path makeScenarioPath() {
		return Paths.get(
			getBaseDir(), DIR_EXAMPLE_SCENARIO, "json", "systest", "FileStorageMetricsThreshold.json"
		);
	}

	@Override
	protected String makeStepId() {
		return JsonFileStorageMetricsThresholdTest.class.getSimpleName() + '-' +
