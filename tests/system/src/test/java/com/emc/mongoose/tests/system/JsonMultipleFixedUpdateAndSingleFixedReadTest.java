 ...
 */
public final class JsonMultipleFixedUpdateAndSingleFixedReadTest
extends OldScenarioTestBase {
	...
	public JsonMultipleFixedUpdateAndSingleFixedReadTest(
	...
	protected String makeStepId() {
		return JsonMultipleFixedUpdateAndSingleFixedReadTest.class.getSimpleName() + '-' +
