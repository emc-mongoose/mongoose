 ...
 */
public class JsonSingleFixedUpdateAndSingleRandomReadTest
extends OldScenarioTestBase {
	...
	public JsonSingleFixedUpdateAndSingleRandomReadTest(
	...
	protected String makeStepId() {
		return JsonSingleFixedUpdateAndSingleRandomReadTest.class.getSimpleName() + '-' +
