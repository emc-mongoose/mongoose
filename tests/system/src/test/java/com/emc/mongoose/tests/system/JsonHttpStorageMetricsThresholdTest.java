...
public class JsonHttpStorageMetricsThresholdTest
extends OldScenarioTestBase {

	private static final double LOAD_THRESHOLD = 0.8;
	private static final int RANDOM_RANGES_COUNT = 10;
	private static final int EXPECTED_STEP_TIME_SECONDS = 30;

	private String stdOutput;

	public JsonHttpStorageMetricsThresholdTest(
	...
	protected String makeStepId() {
		return JsonHttpStorageMetricsThresholdTest.class.getSimpleName() + '-' +
