 ...
 */
@Ignore public class SingleFixedUpdateAndSingleRandomReadTest
extends EnvConfiguredScenarioTestBase {
	...
	throws Exception {
		...
		STEP_ID = SingleFixedUpdateAndSingleRandomReadTest.class.getSimpleName();
		...
		EXPECTED_READ_SIZE = new SizeInBytes(1, ITEM_DATA_SIZE.get(), 1);
