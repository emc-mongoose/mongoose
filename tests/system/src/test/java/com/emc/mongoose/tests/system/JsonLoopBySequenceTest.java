 ...
 */
public final class JsonLoopBySequenceTest
extends OldScenarioTestBase {
	...
	protected String makeStepId() {
		return JsonLoopBySequenceTest.class.getSimpleName() + '-' + storageType.name() + '-' +
			driverCount.name() + 'x' + concurrency.name() + '-' + itemSize.name();
	}

	@Override
	protected Path makeScenarioPath() {
		return Paths.get(getBaseDir(), DIR_EXAMPLE_SCENARIO, "json", "systest", "LoopBySequence.json");
	}
