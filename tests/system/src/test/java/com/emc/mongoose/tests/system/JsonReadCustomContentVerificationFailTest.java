 ...
 */
public class JsonReadCustomContentVerificationFailTest
extends OldScenarioTestBase {

	private String itemOutputPath;

	public JsonReadCustomContentVerificationFailTest(
	...
	protected String makeStepId() {
		return JsonReadCustomContentVerificationFailTest.class.getSimpleName() + '-' +
