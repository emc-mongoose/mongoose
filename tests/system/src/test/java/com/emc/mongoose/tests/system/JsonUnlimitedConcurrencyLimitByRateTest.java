 ...
 */
public class JsonUnlimitedConcurrencyLimitByRateTest
extends OldScenarioTestBase {
	...
	public JsonUnlimitedConcurrencyLimitByRateTest(
	...
	protected Path makeScenarioPath() {
		return Paths.get(
			getBaseDir(), DIR_EXAMPLE_SCENARIO, "json", "systest", "UnlimitedConcurrencyLimitByRate.json"
		);
	}
