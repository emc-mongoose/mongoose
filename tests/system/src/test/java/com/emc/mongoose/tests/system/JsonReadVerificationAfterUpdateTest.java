 ...
 */
public class JsonReadVerificationAfterUpdateTest
extends OldScenarioTestBase {

	private String itemOutputPath;
	private String stdOutput;

	public JsonReadVerificationAfterUpdateTest(
	...
	protected String makeStepId() {
		return JsonReadVerificationAfterUpdateTest.class.getSimpleName() + '-' + storageType.name() +
