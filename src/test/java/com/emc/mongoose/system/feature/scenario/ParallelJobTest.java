...
extends HttpStorageMockTestBase {
	...
	private final static String RUN_ID = ParallelJobTest.class.getCanonicalName();
	...
	@Test
	public void checkConsoleOutputThatJobsAreParallel()
	throws Exception {
		...
		for(final Date startDateTime : startDateTimes) {
			for(final Date finishDateTime : finishDateTimes) {
				Assert.assertTrue(startDateTime.getTime() < finishDateTime.getTime());
			}
		}
	}
}
