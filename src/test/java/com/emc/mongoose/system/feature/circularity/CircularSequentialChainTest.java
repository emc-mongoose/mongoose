		...
		try {
			...
			try (
				...
				COUNT_WRITTEN = client.write(
					null, writeOutput, WRITE_COUNT, 1, SizeInBytes.toFixedSize(DATA_SIZE)
				);
			...
			newConfig.set(AppConfig.KEY_SCENARIO_CHAIN_LOAD, LOAD_SEQ);
			newConfig.set(AppConfig.KEY_SCENARIO_CHAIN_CONCURRENT, false);
			newConfig.set(AppConfig.KEY_API_S3_BUCKET, RUN_ID);
			newConfig.set(AppConfig.KEY_LOAD_LIMIT_COUNT, RESULTS_COUNT);
			RunTimeConfig.setContext(rtConfig);
			//
