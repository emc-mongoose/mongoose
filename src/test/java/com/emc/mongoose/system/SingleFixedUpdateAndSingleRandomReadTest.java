...
public class SingleFixedUpdateAndSingleRandomReadTest {
  ...
  private final String hostItemOutputFile =
      HOST_SHARE_PATH + "/" + getClass().getSimpleName() + ".csv";
  ...
  public SingleFixedUpdateAndSingleRandomReadTest(
    ...
    this.expectedUpdateSize =
        new SizeInBytes(SizeInBytes.toFixedSize("5KB") - SizeInBytes.toFixedSize("2KB"));
  ...
  public final void test() throws Exception {
    ...
    final Consumer<CSVRecord> updateOpTraceTestFunc =
        ioTraceRec -> {
    ...
    assertEquals(
        ...
        EXPECTED_COUNT,
        ioTraceRecCount.sum());
    final Consumer<CSVRecord> readOpTraceTestFunc =
        ioTraceRec -> {
