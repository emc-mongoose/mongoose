...
public class ControlApiTest {
  ...
  private final String HOST =
      "http://localhost:" + MongooseEntryNodeContainer.BUNDLED_DEFAULTS.val("run-port");
  ...
  public ControlApiTest() throws Exception {
    try {
  ...
  private String loadDefaultConfig() throws Exception {
    final String config =
        Files.lines(loadDefaultConfigFile().toPath())
            .map(Object::toString)
            .collect(Collectors.joining("\n"));
    return config;
  }

  private File loadDefaultConfigFile() throws Exception {
