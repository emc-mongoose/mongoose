...
extends DistributedClientTestBase {
	...
	throws Exception {
		System.setProperty(RunTimeConfig.KEY_RUN_ID, UpdateLoggingTest.class.getCanonicalName());
		...
		try(
			...
			final BlockingQueueItemBuffer<WSObject> itemsIO = new BlockingQueueItemBuffer<>(itemsQueue);
