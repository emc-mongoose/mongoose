...
extends ContainerBase {
	...
	throws InterruptedException {
		this(MongooseContainer.IMAGE_VERSION, stepId, storageType, runMode, concurrency, itemSize,
			containerScenarioPath, env, args, attachOutputFlag, collectOutputFlag, outputMetricsTracePersistFlag
		);
	}
	...
	throws InterruptedException {
		this(version, stepId, storageType, runMode, concurrency, itemSize, containerScenarioPath, env, args,
