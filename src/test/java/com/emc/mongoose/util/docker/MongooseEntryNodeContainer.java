...
public final class MongooseEntryNodeContainer extends ContainerBase {
  ...
  public static final String APP_HOME_DIR =
      Paths.get(USER_HOME, "." + APP_NAME, APP_VERSION).toString();
  public static final String CONTAINER_HOME_PATH =
      Paths.get("/root", "." + APP_NAME, APP_VERSION).toString();
  ...
  private static final Map<String, Path> VOLUME_BINDS =
