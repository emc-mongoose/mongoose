...
public class BasicConnectingIOReactor
...
implements ConnectingIOReactor {
     ...
     * @since 4.2
     */
    public BasicConnectingIOReactor(final IOReactorConfig config, final ThreadFactory threadFactory)
     ...
     * @since 4.2
     */
    public BasicConnectingIOReactor(final IOReactorConfig config) throws IOReactorException {
        this(config, null);
    }
     ...
     * @since 4.2
     */
    public BasicConnectingIOReactor() throws IOReactorException {
        this(null, null);
    }

    /**
     * @deprecated (4.2) use {@link BasicConnectingIOReactor#BasicConnectingIOReactor(IOReactorConfig, ThreadFactory)}
     */
    @Deprecated
    public BasicConnectingIOReactor(
        final int workerCount, final ThreadFactory threadFactory, final HttpParams params
    ) throws IOReactorException {
        this(convert(workerCount, params), threadFactory);
    }

    /**
     * @deprecated (4.2) use {@link BasicConnectingIOReactor#BasicConnectingIOReactor(IOReactorConfig)}
     */
    @Deprecated
    public BasicConnectingIOReactor(final int workerCount, final HttpParams params)
    throws IOReactorException {
