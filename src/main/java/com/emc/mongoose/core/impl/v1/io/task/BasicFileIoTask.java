...
import com.emc.mongoose.core.api.v1.item.data.DataCorruptionException;
import com.emc.mongoose.core.api.v1.item.data.DataSizeException;
...
import com.emc.mongoose.core.api.v1.io.task.FileIoTask;
import static com.emc.mongoose.core.api.v1.io.task.IoTask.Status.CANCELLED;
import static com.emc.mongoose.core.api.v1.io.task.IoTask.Status.FAIL_IO;
import static com.emc.mongoose.core.api.v1.io.task.IoTask.Status.FAIL_TIMEOUT;
import static com.emc.mongoose.core.api.v1.io.task.IoTask.Status.RESP_FAIL_CORRUPT;
import static com.emc.mongoose.core.api.v1.io.task.IoTask.Status.RESP_FAIL_NOT_FOUND;
import static com.emc.mongoose.core.api.v1.io.task.IoTask.Status.SUCC;
//
import com.emc.mongoose.core.impl.v1.item.data.BasicDataItem;
import static com.emc.mongoose.core.impl.v1.item.data.BasicMutableDataItem.getRangeCount;
import static com.emc.mongoose.core.impl.v1.item.data.BasicMutableDataItem.getRangeOffset;
//
