...
extends WSRequestConfigBase<T> {
	...
	//
	private SubTenantImpl<T> subTenant;
	//
	...
	//
	public final SubTenantImpl<T> getSubTenant() {
		return subTenant;
	}
	//
	public final RequestConfigImpl<T> setSubTenant(final SubTenantImpl<T> subTenant)
	...
	//
	@Override
	public final RequestConfigImpl<T> setUserName(final String userName) {
	...
	public final RequestConfigImpl<T> setProperties(final RunTimeConfig runTimeConfig) {
		...
		//
		try {
			setSubTenant(new SubTenantImpl<>(this, this.runTimeConfig.getString(KEY_SUBTENANT)));
	...
	throws IOException, ClassNotFoundException {
		...
		setSubTenant(new SubTenantImpl<>(this, String.class.cast(in.readObject())));
	}
	//
	@Override
