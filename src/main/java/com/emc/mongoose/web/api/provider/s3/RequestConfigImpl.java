...
extends WSRequestConfigBase<T> {
	...
	//
	public final BucketImpl<T> getBucket() {
		return bucket;
	}
	//
	public final RequestConfigImpl<T> setBucket(final BucketImpl<T> bucket) {
		this.bucket = bucket;
		return this;
	}
	//
	...
	public final RequestConfigImpl<T> setProperties(final RunTimeConfig runTimeConfig) {
		...
		//
		try {
			setBucket(new BucketImpl<T>(this, this.runTimeConfig.getString(KEY_BUCKET)));
	...
	throws IOException, ClassNotFoundException {
		...
		setBucket(new BucketImpl<T>(this, String.class.cast(in.readObject())));
