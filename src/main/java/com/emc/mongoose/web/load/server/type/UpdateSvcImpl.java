package com.emc.mongoose.web.load.server.type;
//
 ...
 */
public final class UpdateSvcImpl<T extends WSObjectImpl>
extends UpdateImpl<T>
implements ObjectLoadSvc<T> {
	//
	private final static Logger LOG = LogManager.getLogger();
	//
	public UpdateSvcImpl(
		...
		super(runTimeConfig, addrs, reqConf, maxCount, threadsPerNode, null, updatesPerObject);
