 ...
 */
public final class WSBucketProducerImpl<T extends WSObjectImpl>
extends Thread
implements Producer<T> {
	...
	//
	public WSBucketProducerImpl(final WSBucketImpl<T> bucket) {
				...
				if(statusCode == HttpStatus.SC_OK) {
					...
					if(ContentType.APPLICATION_XML.getMimeType().equals(respContentType)) {
						try {
							...
							parser.parse(
								respEntity.getContent(), new WSBucketListHandler<>(consumer)
							);
