 ...
 */
public class WSLoadClientImpl<T extends WSDataObjectImpl>
extends Thread
implements WSLoadClient<T> {
	...
	public final void setConsumer(final Consumer<T> load)
		...
		try { // consumer is map of consumers
			final WSLoadClientImpl<T> loadClient = (WSLoadClientImpl<T>) load;
			final Map<String, LoadSvc<T>> consumeMap = loadClient.remoteLoadMap;
