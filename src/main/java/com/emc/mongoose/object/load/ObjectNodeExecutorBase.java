...
implements ObjectNodeExecutor<T> {
	...
	//
	protected final ObjectRequestConfig<T> localReqConf;
	...
	//
	protected abstract DataObjectRequest<T> getRequestFor(final T dataItem);
	@Override @SuppressWarnings("unchecked")
	public final void submit(final T dataItem) {
		DataObjectRequest<T> request = null;
		try {
