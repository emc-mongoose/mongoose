 ...
 */
public final class WSLoadBuilderClientImpl<T extends WSDataObjectImpl, U extends WSLoadClient<T>>
...
implements WSLoadBuilderClient<T, U> {
	...
	throws RemoteException {
		if(listFile!=null) {
			try {
				srcProducer = (FileProducer<T>) new FileProducer<>(listFile, WSDataObjectImpl.class);
