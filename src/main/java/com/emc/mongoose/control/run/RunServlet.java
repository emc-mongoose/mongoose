...
public class RunServlet extends HttpServlet {
  ...
  protected final void doPost(final HttpServletRequest req, final HttpServletResponse resp)
    ...
    try {
      final Config defaults =
          mergeIncomingWithLocalConfig(defaultsPart, resp, aggregatedConfigWithArgs);
  ...
  void extractRequestTimestampAndApply(
      ...
      throws IOException {
    final String reqTimestampRawValue =
        Collections.list(req.getHeaders(HttpHeader.IF_MATCH.toString())).stream()
            .findAny()
            .orElse(null);
  ...
  static Config mergeIncomingWithLocalConfig(
    ...
    if (defaultsPart == null) {
      ...
      final Config configIncoming =
          configFromPart(defaultsPart, resp, aggregatedConfigWithArgs.schema());
  ...
  static Config configFromPart(
    ...
    try (final BufferedReader br =
        new BufferedReader(new InputStreamReader(defaultsPart.getInputStream()))) {
  ...
  static String getIncomingScenarioOrDefault(final Part scenarioPart, final Path appHomePath)
    ...
    if (scenarioPart == null) {
      ...
      try (final BufferedReader br =
          new BufferedReader(new InputStreamReader(scenarioPart.getInputStream()))) {
