...
implements LoadBuilder<T, U> {
	...
	//
<<<<<<< HEAD:src/main/java/com/emc/mongoose/object/load/WSLoadBuilderImpl.java
	@Override @SuppressWarnings("unchecked")
	public U build()
	throws IllegalStateException {
		if(reqConf == null) {
...
=======
	...
	throws IllegalStateException;
>>>>>>> origin/feature-dev:src/main/java/com/emc/mongoose/base/load/impl/LoadBuilderBase.java
}
