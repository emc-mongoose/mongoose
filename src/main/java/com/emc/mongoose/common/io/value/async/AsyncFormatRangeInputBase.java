...
extends AsyncRangeInputBase<T> {
	 ...
	 */
	protected
	AsyncFormatRangeInputBase(final T minValue, final T maxValue, final String formatString) {
	 ...
	 */
	protected
	AsyncFormatRangeInputBase(final T initialValue, final String formatString) {
		super(initialValue);
		outputFormat = getFormatterInstance(formatString);
	}
