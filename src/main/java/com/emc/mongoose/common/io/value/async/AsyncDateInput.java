...
import com.emc.mongoose.common.io.value.RangeInput;
...
extends AsyncFormatRangeInputBase<Date> {
	...
	public
	AsyncDateInput(final Date minValue, final Date maxValue, final String formatString) {
		super(minValue, maxValue, formatString);
		longGenerator = new AsyncLongInput(minValue.getTime(), maxValue.getTime());
	}

	public
	AsyncDateInput(final Date initialValue, final String formatString)
