 ...
 */
public class DataIoTaskImpl<T extends DataItem>
extends IoTaskImpl<T>
implements DataIoTask<T> {
	...
	protected DataIoTaskImpl(final DataIoTaskImpl<T> other) {
		super(other);
	...
	@Override
	public DataIoTaskImpl<T> result() {
		buildItemPath(item, dstPath == null ? srcPath : dstPath);
		return new DataIoTaskImpl<>(this);
	}
