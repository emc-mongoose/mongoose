...
implements DataOperation<T> {
	...
	public DataOperationImpl(
		final int originIndex, final OpType opType, final T item, final String srcPath,
	...
	public DataOperationImpl(
		...
		this(
			originIndex, opType, item, srcPath, dstPath, credential, fixedRanges, randomRangesCount
		);
