...
/**
 ...
 Note: the {@link java.nio.channels.ReadableByteChannel#read(ByteBuffer)}
...
implements DataItem {
	...
	//
	public DataItemImpl(
		final DataItemImpl baseDataItem, final long internalOffset, final long size,
	...
	////////////////////////////////////////////////////////////////////////////////////////////////
	private static final ThreadLocal<StringBuilder> STRB = ThreadLocal.withInitial(
		StringBuilder::new
	);
	...
	public DataItemImpl slice(final long from, final long partSize) {
		...
		final DataItemImpl dataItemSlice = new DataItemImpl(
