...
import com.emc.mongoose.base.supply.RangeDefinedSupplier;
...
/**
 * This class is a base class to create inputs that produce values of any types (in specified ranges
 * or not), but their values are intended to be converted to String.
 *
