...
import com.emc.mongoose.base.supply.SupplierFactory;
...
public final class AsyncStringSupplierFactory<G extends BatchSupplier<String>>
	...
	public final G createSupplier(
		...
		case 'd': {
			...
			return (G) new AsyncRangeDefinedLongFormattingSupplier(executor, seed, min, max, formatStr);
		}
		...
		case 'f': {
			...
			return (G) new AsyncRangeDefinedDoubleFormattingSupplier(executor, seed, min, max, formatStr);
		}
		...
		case 'D': {
			...
			return (G) new AsyncRangeDefinedDateFormattingSupplier(executor, seed, min, max, formatStr);
		}
