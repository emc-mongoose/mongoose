...
public class MultipleRandomUpdateAndMultipleFixedReadTest {
  ...
  public MultipleRandomUpdateAndMultipleFixedReadTest(
    ...
    this.expectedUpdateSize =
        new SizeInBytes(2 << (UPDATE_RANDOM_RANGES_COUNT - 2), itemSize.getValue().get(), 1);
  ...
  public final void test() throws Exception {
    ...
    // UPDATE
    final Consumer<CSVRecord> ioTraceRecFuncUpdate =
        ioTraceRec -> {
    ...
    final Consumer<CSVRecord> ioTraceRecFuncRead =
        ioTraceRec -> {
