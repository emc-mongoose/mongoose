...
import com.emc.mongoose.model.item.DelayedTransferConvertBuffer;
...
public class DelayedTransferBufferTest {
	...
	throws Exception {
		...
		BUFF = new DelayedTransferConvertBuffer<>(BUFF_CAPACITY, TimeUnit.SECONDS, 0);
	}
