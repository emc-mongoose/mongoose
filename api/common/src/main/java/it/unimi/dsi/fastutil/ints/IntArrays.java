...
public class IntArrays {
	 ...
	 * McIlroy, Keith Bostic and M. Douglas McIlroy, &ldquo;Engineering radix
	 * sort&rdquo;, <i>Computing Systems</i>, 6(1), pages 5&minus;27 (1993).
	 *
	 * <p>
	...
	public static void parallelRadixSort(final int[] a, final int from,
		...
		final ExecutorCompletionService<Void> executorCompletionService = new ExecutorCompletionService<Void>(
			executorService);
	 ...
	 * large as <code>perm</code> (note that the stable version is slightly
	 * faster).
	 *
	 * @param perm
	 *            a permutation array indexing <code>a</code>.
	 * @param a
	 *            the array to be sorted.
	 * @param stable
	 ...
	 *            the array to be sorted.
	 * @param from
	 *            the index of the first element of <code>perm</code>
	 *            (inclusive) to be permuted.
	 * @param to
	 *            the index of the last element of <code>perm</code> (exclusive)
	 *            to be permuted.
	 * @param stable
	 *            whether the sorting algorithm should be stable.
	 */
	 ...
	 * arguments. Pairs of elements in the same position in the two provided
	 * arrays will be considered a single key, and permuted accordingly. In the
	 * end, either <code>a[ i ] &lt; a[ i + 1 ]</code> or
	 * <code>a[ i ] == a[ i + 1 ]</code> and <code>b[ i ] &le; b[ i + 1 ]</code>.
	 *
	 * @param a
	 *            the first array to be sorted.
	 * @param b
	 ...
	 * array as large as <code>perm</code> (note that the stable version is
	 * slightly faster).
	 *
	 * @param perm
	 *            a permutation array indexing <code>a</code>.
