...
public class Object2IntOpenHashMap<K> extends AbstractObject2IntMap<K>
	...
	private final class MapEntrySet
			extends
				AbstractObjectSet<Object2IntMap.Entry<K>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2IntOpenHashMap.this.containsNullKey
						&& ((value[n]) == (v));
	 ...
	 */
	private final class KeyIterator extends MapIterator
			implements
				ObjectIterator<K> {
