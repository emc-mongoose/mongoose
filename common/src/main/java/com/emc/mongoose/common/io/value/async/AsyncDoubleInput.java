...
extends AsyncFormatRangeInputBase<Double> {
	...
	public
	AsyncDoubleInput(final Double minValue, final Double maxValue, final String formatString) {
		super(minValue, maxValue, formatString);
	}

	public
	AsyncDoubleInput(final Double initialValue, final String formatString) {
