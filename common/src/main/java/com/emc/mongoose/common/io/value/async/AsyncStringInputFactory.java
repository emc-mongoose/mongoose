...
import com.emc.mongoose.common.io.value.ValueInputFactory;
...
import static com.emc.mongoose.common.io.value.RangePatternDefinedInput.RANGE_DELIMITER;
import static com.emc.mongoose.common.io.value.async.AsyncDateInput.INPUT_DATE_FMT_STRINGS;
...
implements ValueInputFactory<String, G> {
	...
	public static
	AsyncStringInputFactory<? extends Input<String>> getInstance() {
		return INSTANCE;
	}
