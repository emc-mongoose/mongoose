...
import com.emc.mongoose.io.value.ValueInputFactory;
...
import static com.emc.mongoose.io.value.RangePatternDefinedInput.RANGE_DELIMITER;
import static com.emc.mongoose.io.value.async.AsyncDateInput.INPUT_DATE_FMT_STRINGS;
