...
public class ObjectIterators {
	 ...
	 */
	public static <K> int unwrap(final Iterator<K> i,
			final ObjectCollection<? super K> c, final int max) {
		if (max < 0)
			throw new IllegalArgumentException(
					"The maximum number of elements (" + max + ") is negative");
		int j = max;
	 ...
	 *         (because of duplicates).
	 */
	public static <K> long unwrap(final Iterator<K> i,
			final ObjectCollection<? super K> c) {
		long n = 0;
		while (i.hasNext()) {
			c.add(i.next());
			n++;
	...
	public static <K> int pour(final Iterator<K> i,
			final ObjectCollection<? super K> s, final int max) {
		if (max < 0)
			throw new IllegalArgumentException(
					"The maximum number of elements (" + max + ") is negative");
		int j = max;
	...
	public static <K> int pour(final Iterator<K> i,
			final ObjectCollection<? super K> s) {
	...
	public static <K> ObjectListIterator<K> asObjectIterator(
			final ListIterator<K> i) {
	...
	private static class IteratorConcatenator<K>
		...
		public IteratorConcatenator(final ObjectIterator<? extends K> a[],
	...
	public static <K> ObjectIterator<K> concat(
			final ObjectIterator<? extends K> a[]) {
	...
	public static <K> ObjectIterator<K> concat(
			final ObjectIterator<? extends K> a[], final int offset,
			final int length) {
	...
	public static class UnmodifiableBidirectionalIterator<K>
		...
		public UnmodifiableBidirectionalIterator(
				final ObjectBidirectionalIterator<K> i) {
			this.i = i;
		}
	 ...
	 */
	public static <K> ObjectBidirectionalIterator<K> unmodifiable(
			final ObjectBidirectionalIterator<K> i) {
	 ...
	 */
	public static <K> ObjectListIterator<K> unmodifiable(
			final ObjectListIterator<K> i) {
