...
The [Load Generator](doc/architecture/README.md#load-generator) component is
...
The [Load Step Context](doc/architecture/README.md#load-step-context) component keeps in memory the latest state for all items
