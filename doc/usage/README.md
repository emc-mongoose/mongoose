...
&nbsp;&nbsp;&nbsp;&nbsp;1.2.2. [Reference Table](../interfaces/input/configuration#12-reference-table)<br/>
...
&nbsp;&nbsp;2.1. [General](../interfaces/output#1-general)<br/>
&nbsp;&nbsp;2.2. [Metrics](../interfaces/output#2-metrics)<br/>
