...
public class AtmosStorageDriverTest extends AtmosStorageDriver {
  ...
  public void testRead() throws Exception {
    ...
    final DataItem dataItem =
        new DataItemImpl(itemId, Long.parseLong("00003brre8lgz", Character.MAX_RADIX), itemSize);
    final DataOperation<DataItem> op =
        new DataOperationImpl<>(hashCode(), OpType.READ, dataItem, null, null, credential, null, 0);
