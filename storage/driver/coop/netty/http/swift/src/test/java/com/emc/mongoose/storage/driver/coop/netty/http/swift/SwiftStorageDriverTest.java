...
public class SwiftStorageDriverTest extends SwiftStorageDriver {
  ...
  private static Config getConfig() {
    try {
      final List<Map<String, Object>> configSchemas =
          Extension.load(Thread.currentThread().getContextClassLoader())
              .stream()
  ...
  private SwiftStorageDriverTest(final Config config) throws Exception {
    super(
  ...
  public void testContainerListingTest() throws Exception {
    ...
    final List<Item> items =
        list(itemFactory, container, itemPrefix, Character.MAX_RADIX, markerItem, 1000);
  ...
  public void testCopyRequest() throws Exception {
    ...
    final DataItem dataItem =
        new DataItemImpl(itemId, Long.parseLong(itemId, Character.MAX_RADIX), itemSize);
  ...
  public void testCreateDloPartRequest() throws Exception {
    ...
    final CompositeDataOperation<DataItem> dloOp =
        new CompositeDataOperationImpl<>(
